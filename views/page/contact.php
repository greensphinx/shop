        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-4 col-sm-offset-4 padding-right">
                    ...
                    <?php if ($result): ?>
                        <p class="alert alert-success">Спасибо. Сообщение отправлено! Мы ответим Вам на указанный email в кратчайшие сроки.</p>
                    <?php else: ?>
...
<!--                                <br/>-->
                                <textarea name="userText"><?php echo $userText; ?></textarea>
                                <br><br>
